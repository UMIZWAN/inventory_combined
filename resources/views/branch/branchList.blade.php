...
@section('content')
    <div class="px-4">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="px-4 py-3">
                <table id="branch-table" class="w-full text-sm">
                    <thead>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        @foreach ($branches as $branch)
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-4 py-3">
                                    <span class="font-medium text-gray-800">{{ $branch->branch_name }}</span>
                                </td>
                                <td class="px-4 py-3">
                                    <span
    ...
    {{-- ================= MODAL ================= --}}
    <div id="branch-modal" class="fixed inset-0 hidden flex items-center justify-center bg-black/50 backdrop-blur-sm z-50">
            ...
            <div class="p-6">
                ...
                <div class="flex items-center justify-between mb-6 pb-4 border-b border-gray-200">
                    <div class="flex items-center gap-3">
                        ...
                        <h2 id="branch-modal-title" class="text-xl font-bold text-gray-900">Add Branch</h2>
                    </div>
                    <button id="close-branch-modal" class="text-gray-400 hover:text-gray-600 transition-colors">
                ...
                <form id="branch-form" method="POST" action="{{ url('/branches') }}">
                    ...
                    <div class="flex justify-end gap-3 mt-8 pt-4 border-t border-gray-200">
                        <button type="button" id="cancel-branch-modal"
    ...
    <script>
        ...
        const closeBtns = [
            document.getElementById('close-branch-modal'),
            document.getElementById('cancel-branch-modal')
        ];
        ...
        // Add - Only add listener if button exists (user has permission)
        if (openBtn) {
